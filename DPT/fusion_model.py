...
class FusionModel(nn.Module):
    ...
    def forward(self, upx4_featuremap, upx2_featuremap, noscale_featuremap, downx2_featuremap):
        ...
        return [L2_norm(fuse_2), L2_norm(fuse_1), L2_norm(fuse_0)]
...
class TopMostFusionBlock(nn.Module):
    ...
    def __init__(self, num_channels):
        ...
        self.scale_proj_seq = UpsampleProjectionBlock(num_channels)
    
    # .................................................................................................................
    
    def forward(self, imagelike_feature_map):
        return self.scale_proj_seq(imagelike_feature_map)
...
class FusionBlock(nn.Module):
    ...
    def forward(self, reassembly_feature_map, previous_fusion_feature_map):
        ...
        # Spatially upsample the features along with additional processing
        return self.scale_proj_seq(output)
...
class ResidualConv2D(nn.Module):
    ...
    def __init__(self, num_channels):
        ...
        self.resconv_seq = nn.Sequential(
    ...
    def forward(self, feature_map):
        return self.resconv_seq(feature_map) + feature_map
